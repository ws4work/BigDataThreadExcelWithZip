...
public class DateUtils {
	...
	public static long getOneHoursAgoTime() {
		long oneHourAgoTimeMillis = System.currentTimeMillis() - 60 * 60 * 1000;
		//String oneHoursAgoTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(oneHourAgoTimeMillis);// 获取到完整的时间
		return oneHourAgoTimeMillis;
	}

	//获取前2小时时间
	public static long getTwoHoursAgoTime() {
		long twoHourAgoTimeMillis = System.currentTimeMillis() - 60 * 120 * 1000;
		//String oneHoursAgoTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(oneHourAgoTimeMillis);// 获取到完整的时间
		//System.out.println(oneHoursAgoTime);
		return twoHourAgoTimeMillis;
	}
	...
	public static String getCurYear() {
		...
		return StrUtil.int2str(thisYear);
	}
